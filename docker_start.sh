...
docker run -d -p 8082:80 -v $DATA_DIR/data/apache:/usr/local/apache/data -v $DATA_DIR/conf/apache:/usr/local/apache/conf/conf.d -v $DATA_DIR/logs/apache:/usr/local/apache/logs -v $DATA_DIR/conf/php:/usr/local/php/conf/conf.d -v $DATA_DIR/logs/php:/usr/local/php/logs zhangyz/apache-php:2.2-5.5
